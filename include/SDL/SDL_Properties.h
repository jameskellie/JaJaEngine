...
struct SDL_Properties
{
    ...
    SDL_Properties(const char* WINDOW_TITLE, const int WINDOW_WIDTH, const int WINDOW_HEIGHT, const int TARGET_WIDTH, const int TARGET_HEIGHT, const int RD_INDEX, const uint32_t WINDOW_FLAGS, const uint32_t RENDERER_FLAGS)
